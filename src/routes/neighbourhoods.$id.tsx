...
const HOUSING_GRAPHS = [
  { key: 'price_hist', title: 'Price Distribution', containerId: 'bokeh-price-hist-container' },
  { key: 'price_over_time', title: 'Median Price Over Time', containerId: 'bokeh-price-over-time-container' },
  { key: 'price_by_type', title: 'Price by House Type', containerId: 'bokeh-price-by-type-container' },
  { key: 'beds', title: 'Bedroom Distribution', containerId: 'bokeh-beds-container' },
] as const
...
function StatCard({ label, value, cityValue }: { label: string; value: string | null; cityValue?: string }) {
  return (
  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-10 space-y-10">
      <header>
        ...
        <p className="text-xl text-slate-600 mt-2">Toronto neighbourhood housing snapshot</p>
      </header>
      ...
      <section>
        <h2 className="text-2xl font-bold tracking-tight mb-6">Housing Market Data</h2>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <StatCard label="Total Population" value={fmt_pop(stats?.population ?? null)} />
          <StatCard
            label="Use Public Transit"
            value={fmt_pct(stats?.transit_pct ?? null)}
            cityValue={stats ? fmt_pct(stats.city.transit_pct) ?? undefined : undefined}
          />
        </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <StatCard
            ...
            cityValue={stats ? fmt_pct(stats.city.non_english_pct) ?? undefined : undefined}
          />
        </div>
        <Card className="overflow-hidden">
          <CardHeader className="pb-2">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <StatCard
            ...
            cityValue={stats ? fmt_pct(stats.city.bachelor_pct) ?? undefined : undefined}
          />
        </div>
        <Card className="overflow-hidden">
          <CardHeader className="pb-2">
